...
Wechat.prototype = {
    ...
    inquiryDefineMenu: function () {
        var that = this,url = api.menu.inquiryMenu + 'access_token=' + that.access_token;
        var options = {method: 'GET', url: url, json: true};
    ...
    createTag: function (tagName) {
        var that = this,url = api.tags.createTag + 'access_token=' + that.access_token;
        var options = { method: 'POST', url: url, body: { access_token: that.access_token,name: tagName }, json: true };
